    ...
    public class FootIK : MonoBehaviour
    {
        ...
        void SetFootIK()
        {
            ...
            if (IkEnabled)
            {
                ...
                //if(animator.GetFloat("moveAmount") > 0.05f)
                //{
                //    offs = Mathf.Lerp(offs, 0, Time.deltaTime * hipIKSmooth);
                //    root.localPosition = offs * hips.up;
                //    prevPos = transform.position;
                ...
                var idleVal = (animator.GetFloat("idleType") < 0.5f ? 0.1f : 1);
                ...
                var isInCrouchIdle = animator.GetFloat("crouchType") > 0.5f && idleVal > 0.5f;
                ...
                if (!isInCrouchIdle)
                {
                    ...
                    animator.SetIKRotationWeight(AvatarIKGoal.RightFoot, leftFootIKWeight * 0.6f);
                    animator.SetIKRotationWeight(AvatarIKGoal.LeftFoot, rightFootIKWeight * 0.6f);
                }
                animator.SetIKPositionWeight(AvatarIKGoal.LeftFoot, leftFootIKWeight * (1 - animator.GetFloat("moveAmount") * 2f));
                animator.SetIKPositionWeight(AvatarIKGoal.RightFoot, rightFootIKWeight * (1 - animator.GetFloat("moveAmount") * 2f));
