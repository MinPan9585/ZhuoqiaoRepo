...
public class DemoController : MonoBehaviour
{
	...
	void FixedUpdate()
	{
        if (bInActivate || animator.GetCurrentAnimatorStateInfo(0).IsName("Activate") || animator.GetCurrentAnimatorStateInfo(0).IsName("Idle_Inactive"))
            return;
	...
	void Update()
	{
		if (!dead)
		{
            ...
            // activate
            if (Input.GetKeyDown(KeyCode.A) && bInActivate)
            {
